...
?>
		<div id="sm-update" class="box">
			...
			<p>
				Vývoj aplikace Mozilla Suite byl ukonèen. Doporuèujeme vám aplikaci
				<a href="http://www.seamonkey-project.org/">SeaMonkey</a>,
				která nabízí stejný rozsah funkcí, totožné uživatelské rozhraní,
				vìtší rychlost a&nbsp;navíc øadu zajímavých novinek</a>.
			</p>
			<div>
				<a href="http://www.mozilla.cz/stahnout/#seamonkey">stáhnout SeaMonkey</a> &middot;
				<span onclick="setCookie('ignoreMS17Update',1,300);document.getElementById('sm-update').style.display='none'">již neupozoròovat</span>
			</div>
		</div>
<?php
	}
...
?>
		<div id="sm-update" class="box">
			...
			<p>
				Používáte starou verzi prohlížeèe <a href="http://www.mozilla-europe.org/cs/firefox/">Mozilla Firefox</a>.
			...
			<div>
				...
				<span onclick="setCookie('ignoreFFUpdate',1,300);document.getElementById('sm-update').style.display='none'">již neupozoròovat</span>
			</div>
		</div>
<?php
	}
