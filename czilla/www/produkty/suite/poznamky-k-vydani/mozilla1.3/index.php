<?php
	...
	$page->setTitle('Mozilla Suite &ndash; Poznámky k vydání verze 1.3');
	$page->setHeadline('Poznámky k vydání','Popis změn a novinek ve verzi 1.3');
	$page->setKeywords ('mozilla, suite, poznámky k vydání, verze, gecko, prohlížeč, poštovní klient, editor, chatzilla');
	$page->setDescription ('Poznámky k vydání historických verze 1.3');
	$page->setMenu('produkty');
	$page->includeTemplate('header');
?>

<p>Tyto <a href="/produkty/suite/poznamky-k-vydani/">poznámky k verzi</a> popisují systémové požadavky, pokyny k instalaci a známé problémy týkající se Mozilly verze 1.3.</p>
...
<h2 id="new">Co je nového v Mozille 1.3</h2>
<ul>
	<li>Mozilla obsahuje rozlišování nevyžádaných mailů (junk-mail classification). Po krátkém počátečním "tréninku" dokáže Mozilla rozlišit nevyžádanou poštu a oddělit ji od běžných mailů. Více se o rozlišování nevyžádané pošty můžete dočíst na <a href="http://www.mozilla.org/mailnews/spam-howto.html">mozilla.org</a> [EN].</li>
	<li>Tato verze obsahuje filtry i pro diskusní skupiny.</li>
	<li>Projekt Mozilla Midas (implementace pole pro editaci formátovaného textu - rich text editing control), byl zařazen do této verze. O projektu Midas se více dozvíte na <a href="http://www.mozilla.org/editor/midas-spec.html">mozilla.org</a> [EN].</li>
	...
	<li>Uživatelé nyní mohou dynamicky (bez ručního vypínání Mozilly) měnit uživatelský profil. Pokud to chcete vyzkoušet, vyberte v nabídce 'Nástroje' položku 'Přepnout profil...'.</li>
	...
	<li>Mozilla 1.3 je po mnohých úpravách o něco rychlejší a více vyhovuje internetovým standardům.</li>
	<li>Mozilla obsahuje nové vítací okno (splashscreen). Prosíme, neupozorňujte nás na to zbytečně v Bugzille. My o tom víme.</li>
	<li>RPM balíčky pro RedHat jsou nyní kompilovány kompilátorem GCC 3.2.</li>
</ul>
...
<ul>
	<li>Na systému Mac OS X je u verze 1.3 zakázán XPinstall. Znamená to, že na Mac OS X nepůjdou instalovat nová témata vzhledu a přídavné aplikace. (chyba <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=196959">196959</a>)</li>
	<li>Program pro kontrolu překlepů z <a href="http://www.mozdev.org">mozdev.org</a> určený pro předchozí verze Mozilly nefunguje s verzí 1.3 a novějšími a způsobuje padání Mozilly. Použijte <a href="http://spellchecker.mozdev.org/installation.html#mozilla1.3b">novější verzi</a> kontroloru překlepů. (chyba <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=185251">185251</a>)</li>
	<li>MRJ Java plugin pro Mozillu 1.3 není dostupný, proto LiveConnect nefunguje. Mozilla pro zobrazení appletů použije Applovský Java applet zásuvný modul (plugin). (<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=97613">97613</a>)</li>
	<li>Formuláře založené na XBL ovládacích prvcích jsou poškozeny a ve verzi 1.3 nepoužitelné. (chyba <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=185612">185612</a>) Pokud se ovládací prvky formulářů na HTML stránkách nezobrazují a nefungují, podívejte se do souboru 'prefs.js' zda neobsahuje řádek 'user_pref("nglayout.debug.enable_xbl_forms", true);'. <br />Poznámka: tento problém se vyskytne pouze tehdy, pokud jste tuto možnost zapnuli v některé z předchozích verzích Mozilly v panelu 'Debug' v předvolbách. Běžní uživatelé by nikdy neměli měnit tato nastavení.</li>
</ul>
...
<ul>
	...
	<li>Uživatelé Red Hatu 8.x používající Mozillu v RPM musí mít pluginy kompatibilní s GCC 3.2, zejména Java plugin.</li>
	<li>Procesor třídy Intel pentium (doporučujeme 233 MHz nebo rychlejší)</li>
	<li>64 MB RAM</li>
	<li>26 MB volného místa na disku</li>
</ul>
...
<p><strong>Windows:</strong> Pokud používáte verze Mozilly s instalátorem a již máte JRE 1.3.0_01 na vašem systému, Mozilla by to měla automaticky poznat. Pokud jste ručně nastavili zákaz automatického hledání pluginů, tak pro zprovoznění Javy učiňte následující krok. Po instalaci Javy na váš počítač zkopírujte soubor <tt>NPOJI610.dll</tt> z instalačního adresáře (obvykle něco jako <tt>C:\Program Files\JavaSoft\JRE\1.3.0_01\bin</tt>) do adresáře pluginů Mozilly (obvykle <tt>C:\Program Files\Mozilla 1.3\plugins</tt>).</p>
...
<ol>
	...
	<li>Extrahujte soubory z archivu do adresáře např. <tt>C:\Program Files\Mozilla 1.3</tt> .</li>
...
<ol>
	<li>Vytvořte adresář mozilla1.3 (<code>mkdir mozilla1.3</code>) a přemístěte se do tohoto adresáře (<code>cd mozilla1.3</code>).</li>
	<li>Klikněte na odkaz na soubor s instalátorem (jmenuje se <tt>Mozilla-i686-pc-linux-gnu-installer.tar.gz</tt>) a stáhněte jej do vytvořeného adresáře mozilla1.3.</li>
	<li>V adresáři mozilla1.3 rozbalte archiv následujícím příkazem: <code> gunzip -dc moz*.tar.gz | tar -xvf -<br /></code> (Ten rozbalí instalátor do podadresáře <tt>mozilla-installer</tt>.)</li>
...
<ol>
	...
	<li>V Mozilla adresáři (<code>mozilla1.3</code>) rozbalte soubor následujícím příkazem: <code> gunzip -dc moz*.tar.gz | tar -xvf -</code> (Vytvoříte tím podadresář "mozilla" v adresáři mozilla1.3.)</li>
...
<h3>Linux</h3>
<ul>
	<li>Smažte adresář <tt>mozilla1.3</tt>, do kterého jste nainstalovali Mozillu</li>
	<li>Smažte adresář <tt>~/.mozilla</tt>, který obsahuje infomace vašeho profilu</li>
</ul>

<h3>Windows</h3>
<ul>
	<li>V "Nastavení/Ovládací panely/Přidat nebo odebrat programy" zvolte "Mozilla 1.3"</li>
</ul>
...
<p><strong>Linux:</strong> LiveConnet nyní funguje, pokud používáte Mozillu 1.3 s JRE 1.3.1. U verze JDK 1.4 se vyskytly problémy zmiňované výše.</p>
...
<ul>
	...
	<li>Na&nbsp;Unixu: je vytvořen symbolický odkaz na <tt>/usr/java/j*/jre/plugins/i386/ns610/libjavaplugin_oji.so</tt> z podadresáře <tt>plugins/</tt> v adresáři s nainstalovanou Mozillou&nbsp;1.3. Nekopírujte soubor, pouze vytvořte symbolický odkaz.</li>
</ul>
...
<p><small>Tento dokument je překladem <a href="http://www.mozilla.org/releases/mozilla1.3/">dokumentu z mozilla.org</a>. Copyright &copy; 1998-2003 The Mozilla Organization</small></p>
