<?php
	...
	$page->setTitle('Aktualizace článku Mozilla na CD - uvítáme pomoc');
	$page->setHeadline('Aktualizace článku Mozilla na CD - uvítáme pomoc', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2005/09/09/">Ze stejného dne</a></dd>
