<?php
	...
	$page->setTitle('Přehled souborů v profilu aplikací Mozilla');
	$page->setHeadline('Přehled souborů v profilu aplikací Mozilla', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2007/08/">Ze stejného měsíce</a></dd>
