<?php
	...
	$page->setTitle('CZilla nabízí 100 lokalizovaných rozšíření!');
	$page->setHeadline('CZilla nabízí 100 lokalizovaných rozšíření!', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2005/07/25/">Ze stejného dne</a></dd>
