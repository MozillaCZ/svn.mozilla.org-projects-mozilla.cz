<?php
	...
	$page->setTitle('CZilla připravila průvodce, který řeší nejčastější chyby webmasterů');
	$page->setHeadline('CZilla připravila průvodce, který řeší nejčastější chyby webmasterů', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2005/04/06/">Ze stejného dne</a></dd>
