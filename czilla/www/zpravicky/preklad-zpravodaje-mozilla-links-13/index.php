<?php
	...
	$page->setTitle('Překlad zpravodaje Mozilla Links 13');
	$page->setHeadline('Překlad zpravodaje Mozilla Links 13', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Další zprávičky:</dt>
				<dd><a href="../2004/03/">Ze stejného měsíce</a></dd>
