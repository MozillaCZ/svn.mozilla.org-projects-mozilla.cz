<?php
	...
	$page->setTitle('CZilla se rozrůstá o dva nové členy');
	$page->setHeadline('CZilla se rozrůstá o dva nové členy', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2005/02/11/">Ze stejného dne</a></dd>
