<?php
	...
	$page->setTitle('Přehled lokalizovaných rozšíření');
	$page->setHeadline('Přehled lokalizovaných rozšíření', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2005/01/29/">Ze stejného dne</a></dd>
