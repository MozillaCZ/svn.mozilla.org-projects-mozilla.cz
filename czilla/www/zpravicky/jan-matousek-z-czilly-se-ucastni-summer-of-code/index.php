<?php
	...
	$page->setTitle('Jan Matoušek z CZilly se účastní Summer of Code');
	$page->setHeadline('Jan Matoušek z CZilly se účastní Summer of Code', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="/zpravicky/s/mozilla-foundation-corporation/">Mozilla Foundation &amp; Corporation</a></dd>
				<dt>Další zprávičky:</dt>
				<dd><a href="../2006/05/25/">Ze stejného dne</a></dd>
