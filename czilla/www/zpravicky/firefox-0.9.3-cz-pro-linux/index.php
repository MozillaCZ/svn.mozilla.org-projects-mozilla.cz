<?php
	...
	$page->setTitle('Firefox 0.9.3 CZ pro Linux');
	$page->setHeadline('Firefox 0.9.3 CZ pro Linux', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2004/09/02/">Ze stejného dne</a></dd>
				<dd><a href="../2004/09/">Ze stejného měsíce</a></dd>
