<?php
	...
	$page->setTitle('CZilla obhajuje úspěch v anketě CZECH OPEN SOURCE');
	$page->setHeadline('CZilla obhajuje úspěch v anketě CZECH OPEN SOURCE', 'Zprávičky ze světa Mozilly');
