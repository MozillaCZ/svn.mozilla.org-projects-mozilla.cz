<?php
	...
	$page->setTitle('Greasemonkey skript pro Oskarovu SMS bránu');
	$page->setHeadline('Greasemonkey skript pro Oskarovu SMS bránu', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2005/06/27/">Ze stejného dne</a></dd>
