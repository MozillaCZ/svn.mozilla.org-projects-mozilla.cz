<?php
	...
	$page->setTitle('Firefox na konferenci Openchange v Olomouci');
	$page->setHeadline('Firefox na konferenci Openchange v Olomouci', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2006/11/">Ze stejného měsíce</a></dd>
