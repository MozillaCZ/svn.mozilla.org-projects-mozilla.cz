<?php
	...
	$page->setTitle('AbcLinuxu připravuje on-line rozhovor s Pavlem Cvrčkem');
	$page->setHeadline('AbcLinuxu připravuje on-line rozhovor s Pavlem Cvrčkem', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2005/04/08/">Ze stejného dne</a></dd>
