<?php
	...
	$page->setTitle('Překlad zpravodaje Mozilla Links 7');
	$page->setHeadline('Překlad zpravodaje Mozilla Links 7', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Další zprávičky:</dt>
				<dd><a href="../2004/01/03/">Ze stejného dne</a></dd>
