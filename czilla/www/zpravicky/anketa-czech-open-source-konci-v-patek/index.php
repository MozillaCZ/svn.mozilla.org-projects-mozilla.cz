<?php
	...
	$page->setTitle('Anketa CZECH OPEN SOURCE končí v pátek');
	$page->setHeadline('Anketa CZECH OPEN SOURCE končí v pátek', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2006/03/28/">Ze stejného dne</a></dd>
