<?php
	...
	$page->setTitle('CZilla nominována do ankety CZECH OPEN SOURCE 2006');
	$page->setHeadline('CZilla nominována do ankety CZECH OPEN SOURCE 2006', 'Zprávičky ze světa Mozilly');
