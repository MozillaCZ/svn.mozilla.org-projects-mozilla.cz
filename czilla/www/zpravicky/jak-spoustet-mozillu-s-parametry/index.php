<?php
	...
	$page->setTitle('Jak spouštět Mozillu s parametry');
	$page->setHeadline('Jak spouštět Mozillu s parametry', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2005/01/03/">Ze stejného dne</a></dd>
