<?php
	...
	$page->setTitle('Překlad zpravodaje Mozilla Links');
	$page->setHeadline('Překlad zpravodaje Mozilla Links', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Další zprávičky:</dt>
				<dd><a href="../2003/12/03/">Ze stejného dne</a></dd>
