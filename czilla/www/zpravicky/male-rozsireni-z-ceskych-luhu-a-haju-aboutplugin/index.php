<?php
	...
	$page->setTitle('Malé rozšíření z českých luhů a hájů: AboutPlugin');
	$page->setHeadline('Malé rozšíření z českých luhů a hájů: AboutPlugin', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2005/07/15/">Ze stejného dne</a></dd>
