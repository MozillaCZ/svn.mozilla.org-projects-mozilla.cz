<?php
	...
	$page->setTitle('Rozhovor s Martinem Hassmanem na LinuxEXPRESu');
	$page->setHeadline('Rozhovor s Martinem Hassmanem na LinuxEXPRESu', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2005/05/02/">Ze stejného dne</a></dd>
