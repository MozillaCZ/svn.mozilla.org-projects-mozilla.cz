<?php
	...
	$page->setTitle('Jak pomoci projektu CZilla');
	$page->setHeadline('Jak pomoci projektu CZilla', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2005/09/28/">Ze stejného dne</a></dd>
