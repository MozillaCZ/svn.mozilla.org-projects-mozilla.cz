<?php
	...
	$page->setTitle('Lokalizovaná rozšíření stále přibývají - pomozte nám, ať je jich ještě víc');
	$page->setHeadline('Lokalizovaná rozšíření stále přibývají - pomozte nám, ať je jich ještě víc', 'Zprávičky ze světa Mozilly');
