<?php
	...
	$page->setTitle('Rozhovor o Firefoxu s Jiřím Burdou');
	$page->setHeadline('Rozhovor o Firefoxu s Jiřím Burdou', 'Zprávičky ze světa Mozilly');
...
<dl class="news">
		<dt>Štítky:</dt>
				...
				<dd><a href="../2004/11/29/">Ze stejného dne</a></dd>
				<dd><a href="../2004/11/">Ze stejného měsíce</a></dd>
