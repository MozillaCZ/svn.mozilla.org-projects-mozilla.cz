<?php
	...
	$page->title    = 'Tipy a triky pro prohlížeč Firefox';
	$page->headline = array('Tipy a triky','Jak si můžete upravit prohlížeč Firefox');
...
prohlížeč Mozilla z balíku Mozilla. Řada z nich vyžaduje úpravu textových souborů ve vašem <a href="konfigurace.html">uživatelském profilu</a>
...
přidejte následující kód do souboru <a href="konfigurace.html#css">userChrome.css.</a></p>
...
vlastního pozadí pro nástrojové lišty a to přidáním následující kódu do souboru <a href="konfigurace.html#css">userChrome.css.</a></p>
...
<a href="konfigurace.html#css">userChrome.css.</a> Obrázek může být v jakémkoliv formátu, jenž je podporován prohlížečem
Mozilla Firefox.</p>
');
...
následující kód do souboru <a href="konfigurace.html#css">userChrome.css.</a></p>
...
následujícího kódu do souboru <a href="konfigurace.html#css">userChrome.css.</a></p>
...
<p>Pro zobrazení Postranní lišty na pravé straně okna, místo na levé, přidejte do souboru <a href="konfigurace.html#css">userChrome.css</a> následující kód.</p>
...
zobrazenou, přidejte následující kód do souboru <a href="konfigurace.html#user">user.js.</a></p>
...
Pro donucení k otevření ve stejném okně, přidejte do souboru <a href="konfigurace.html#user">user.js</a> následující kód.</p>
...
vychytávky, přidejte následující kód do souboru <a href="konfigurace.html#user">user.js.</a></p>
...
nastavení, přidejte do souboru <a href="konfigurace.html#user">user.js</a> některý z následujících kódů:</p>
...
<p>Prohlížeč Mozilla Firefox má vlastnost jemného rolování standardně zapnutou. Pro vypnutí přidejte do souboru <a href="konfigurace.html#user">user.js</a> následující kód.</p>
...
přidejte do souboru <a href="konfigurace.html#user">user.js</a> následující kód.</p>
...
<a href="konfigurace.html#user">user.js</a> následující kód.</p>
...
URL přidáním následujícího kódu do souboru <a href="konfigurace.html#user">user.js.</a></p>
...
Pro zákaz zobrazování některých reklam v Internetu, přidejte do souboru <a href="konfigurace.html#content">userContent.css</a>
následující kód.</p>
...
odkazy, přidejte do souboru <a href="konfigurace.html#content">userContent.css</a> následující kód.</p>
...
<p>Pokud shledáte blikání textu obtěžující, přidejte do souboru <a href="konfigurace.html#user">user.js</a> následující kód.</p>
...
přidejte do souboru <a href="konfigurace.html#content">userContent.css</a> následující kód.</p>
...
v jakém je server požádán o webovou stránku, a to přidáním následujícího kódu do souboru <a href="konfigurace.html#user">user.js.</a></p>
...
protože čeká příchozí data od webového serveru. Přidáte-li následující kód do souboru <a href="konfigurace.html#user">user.js</a>,
...
špatně podporovaná některými webovými servery, či proxy. Pro vyzkoušení přidejte do souboru <a href="konfigurace.html#user">user.js</a>
následující kód.</p>
...
<p>Pro určení adresáře s vyrovnávací pamětí, přidejte do souboru <a href="konfigurace.html#user">user.js</a> následující kód.</p>
...
Pro určení specifického množství vyrovnávací paměti, přidejte do souboru <a href="konfigurace.html#user">user.js</a> následující kód.</p>
