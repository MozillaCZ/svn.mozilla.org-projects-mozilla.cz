<?php
	...
	$page->title    = 'Mozilla Kalendář &amp; Sunbird - Často kladené otázky';
	$page->headline = array('Mozilla Kalendář &amp; Sunbird FAQ','Často kladené otázky');

	$page->setKeywords ('firefox, thunderbird, mozilla suite, diář, kalendář, calendar, plánování');
	$page->setDescription ('Stránky podpory diáře Mozilla Kalendář');

	$page->addSideBox('menu','produkty');
	$page->addSideBox('downloads','kalendar');
	$page->addSideBox('links','produkty');
	$page->addSideBox('tips','kalendar');
