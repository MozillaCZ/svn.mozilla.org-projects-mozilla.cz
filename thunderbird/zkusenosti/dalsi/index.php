<?php
	...
	setTitle("Další zkušenosti lidí, kteří již používají Thunderbird");
	$page_desc  = "Přicházejí nám e-maily od lidí, kteří popisují svoji zkušenost s přechodem na klient Mozilla Thunderbird. Přečtěte si, co je zaujalo, čím je Thunderbird potěšil a co si o Thunderbirdu myslí.";
	$page_keywords  = "zkušenost zážitek mozilla thunderbird outlook express změna";
