<?php
	...
	setTitle("Lukáš Janoušek: Thunderbird šetří můj čas i nervy");
	$page_desc  = "Zdeněk Koch o tom, jak mu Thunderbird šetří čas";
	$page_keywords	= "mozilla thunderbird poštovní klient čas legálně zdarma";
